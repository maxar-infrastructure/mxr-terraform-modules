...
variable "ca_cert_identifier" {
  description = "The name of the CA cert to use for the RDS database."
  default     = null
  type        = string
}
...
variable "app_security_group" {
  description = "Security Group ID to allow inbound access to the DB"
  type        = string
  default     = ""
}
...
variable "storage_encrypted" {
  description = "Allow for enable encryption of instance storage using default kms, and leave false for integrations"
  default     = false
}
